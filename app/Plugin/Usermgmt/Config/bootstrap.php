...
function UsermgmtInIt(&$controller) {
	...
	*/
	...
	/*
		set Org Admin group id here
	*/
	if(!defined("ORG_ADMIN_GROUP_ID")) {
		define("ORG_ADMIN_GROUP_ID", 7);
	}
	/*
		set Org Admin group id here
	*/
	if(!defined("DOC_GROUP_ID")) {
		define("DOC_GROUP_ID", 8);
	}
	/*
		set Org Admin group id here
	*/
	if(!defined("REC_GROUP_ID")) {
		define("REC_GROUP_ID", 9);
	}
	/*
		set Org Admin group id here
	*/
	if(!defined("QC_GROUP_ID")) {
		define("QC_GROUP_ID", 6);
	}
