...
class UserAuthHelper extends AppHelper {
	...
	/**
	 * Used to check is "org admin" logged in
	 *
	 * @access public
	 * @return string
	 */
	...
	/**
	 * Used to check is "Co-ordinater" logged in
	 *
	 * @access public
	 * @return string
	 */
