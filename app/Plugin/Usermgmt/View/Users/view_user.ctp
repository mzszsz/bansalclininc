...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><?php echo __('User Detail'); ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			...
			<?php       if (!empty($user)) { ?>
							...
							<tr>
								<td><strong><?php echo __('User Image');?></strong></td>
								<td><?php if(h($user['User']['image_url'])!=''){?><img src="<?php echo $this->webroot.h($user['User']['image_url']); ?>" width="100"><?php } else{
									echo "No image";
								}
								?>
								</td>
