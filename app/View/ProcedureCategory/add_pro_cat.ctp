...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><?php echo __('Add Procedure Category'); ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            	...
            	<div class="col-md-12">
            		<div class="panel panel-default">
                        <div class="panel-heading">
                            <?php echo __('Add Procedure Category'); ?>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                	...
                                	<?php echo $this->Form->input("admin_id" ,array('label' => false,'div' => false,'type'=>"hidden",'value'=>$this->UserAuth->getUserId() ))?>
											...
											<div class="form-group">
												<label></label>
												<div class="umstyle4"><?php echo $this->Form->Submit(__('Add Category'),array("class"=>"btn btn-primary"));?></div>
											</div>
